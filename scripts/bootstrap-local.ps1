...
Write-Host "4. python -m uvicorn api.main:app --reload"
Write-Host "5. nvm use 24  # optional, if you manage Node with nvm"
Write-Host "6. cd frontend; npm install; npm run generate:api; npm run dev"
